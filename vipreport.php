<div id="middle_right_top">
		...
		if(isset($_POST['search']) && empty($_POST['empids']) && empty($_POST['empname']) && empty($_POST['charge']) &&
		empty($_POST['day']) && !empty($_POST['smonth']) && empty($_POST['project']))
		{
		...
		$etime=$ts2->format('U');
		$result = mysql_query("SELECT * FROM timetable WHERE (date between $stime and $etime)");
		include("monthfunc.php");
		}

		/*if(isset($_POST['search']) && !empty($_POST['empids']) && empty($_POST['empname']) && empty($_POST['charge']) &&
		empty($_POST['day']) && !empty($_POST['smonth']))
		{
		$da1 = firstFriday($_POST['smonth'],1);
		$ts1 = new DateTime($da1);
		$stime=$ts1->format('U');
		...
		$ts2 = new DateTime($da2);
		$etime=$ts2->format('U');
		$result = mysql_query("SELECT * FROM timetable WHERE (date between $stime and $etime) and empid='$_POST[empids]'");
		include("monthfunc.php");
		}*/

	    if(isset($_POST['search']) && empty($_POST['empids']) && !empty($_POST['empname']) && empty($_POST['charge']) &&
	    empty($_POST['day']) && !empty($_POST['smonth']) && empty($_POST['lyear']))
		{
		$da1 = firstFriday($_POST['smonth'],1);
		$ts1 = new DateTime($da1);
		$stime=$ts1->format('U');
		...
		empty($_POST['day']) && empty($_POST['smonth']) )
		{
		$result = mysql_query("SELECT * FROM timetable WHERE empid ='$_POST[empids]'");
		...
		empty($_POST['day']) && empty($_POST['smonth']) )
		{
		$result = mysql_query("SELECT * FROM timetable WHERE empname ='$_POST[empname]'");
		include("searchfunc.php");
		}
		...
		$wend = $ts->format('U');
		$result = mysql_query("SELECT * FROM timetable WHERE date ='$wend'");
		include("searchfunc.php");
		}
		...
		empty($_POST['day']) && empty($_POST['smonth']) )
		{
		$result = mysql_query("SELECT * FROM timetable WHERE chargecode ='$_POST[charge]'");
		include("searchfunc.php");
		}
        ...
        $ts = new DateTime($_POST['day']);
        $wend = $ts->format('U');
        $result = mysql_query("SELECT * FROM timetable WHERE chargecode ='$_POST[charge]' and date='$wend'");
        include("searchfunc.php");
        }
		...
		empty($_POST['day']) && empty($_POST['smonth']) )
        {
        $result = mysql_query("SELECT * FROM timetable WHERE project ='$_POST[project]'");
        include("searchfunc.php");
        }
